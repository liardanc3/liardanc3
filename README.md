...
<div align="left" style="border:1px solid #e1e4e8; border-radius:12px; padding:14px; margin:8px 0;">
  <details open>
    <summary style="font-size: 0.8em;"> 
      <b style="color:#24292f;">인천대학교 교내 지도 앱</b>
    </summary>
    <picture>
  <source media="(prefers-color-scheme: dark)"
          srcset="https://skillicons.dev/icons?i=java&spring&perline=12&theme=dark" />
  <img alt="Tech Stack"
       src="https://skillicons.dev/icons?i=java&spring&perline=12" />
</picture>
    <div style="font-size: 0.75em; line-height: 1.3;">
      - <b><a href="https://github.com/liardanc3/inunavi" target="_blank" style="text-decoration:none; color:#24292f;">졸업작품</a> | Backend 담당</b><br>
      - 캠퍼스 지리에 익숙치 않은 신입생 및 복학생을 위한 안드로이드 교내 지도 어플로 Android, Spring, <br>
...
<!-- 다이어리 SNS 앱 카드 -->
<div align="left" style="border:1px solid #e1e4e8; border-radius:12px; padding:14px; margin:8px 0;">
  <details open> <!-- open 속성을 추가하여 기본 열림 상태 -->
    <summary style="font-size: 0.8em;"> <!-- summary 텍스트 크기 조정 -->
      <b style="color:#24292f;">다이어리 SNS 앱(ios)</b>
    </summary>
    <br>
    <div style="font-size: 0.75em; line-height: 1.3;"> <!-- detail 내용 텍스트 크기 조정 -->
      - <b><a href="https://github.com/liardanc3/SoSoHappy-BackEnd" target="_blank" style="text-decoration:none; color:#24292f;">사이드 프로젝트</a> | Backend, Infra</b><br>
...
<div align="left" style="border:1px solid #e1e4e8; border-radius:12px; padding:14px; margin:8px 0;">
  <details> <!-- 기본적으로 닫혀있음 -->
    ...
    <br>
    <div style="font-size: 0.75em; line-height: 1.3;"> <!-- detail 내용 텍스트 크기 조정 -->
      - <b>회사 프로젝트 | Backend, Frontend(Angular)</b><br>
